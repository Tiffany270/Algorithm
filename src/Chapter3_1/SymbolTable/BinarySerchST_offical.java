...
public class BinarySerchST_offical<Key extends Comparable<Key>, Value> {
	 ...
	 */
	public BinarySerchST_offical(int capacity) {
	 ...
	 * @throws IllegalArgumentException
	 *             unless {@code k} is between 0 and <em>n</em>¨C1
	 */
